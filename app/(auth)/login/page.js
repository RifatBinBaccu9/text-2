  ...
  return (
    <div className='header_top h-[800px] xl:h-[1024px] flex container justify-center md:justify-between items-center gap-[25px] lg:gap-[50px]'>
        ...
        <form action="" className=" select-none">
          <div>
            <h1 className="font-jost font-bold text-[30px] mb-[5px]">
              Welcome 👋
            </h1>
            <p className="text-base font-jost font-normal mb-[30px]">
              Please login here
            </p>
          </div>
          <label
            htmlFor="email"
            className="text-[12px] font-jost font-normal mb-[2px]"
          >
            Email Address
          </label>
          <input
            ...
            className="w-full p-4 outline-none border border-black  rounded-[10px] text-base font-jost font-normal mb-[18px]"
          />
          ...
          <input
            ...
            className="w-full p-4 outline-none border border-black rounded-[10px] text-base font-jost font-normal"
          />
          <div className="flex justify-between mt-[18px] mb-[32px]">
            <div className="flex gap-3">
              <Checkbox
                onChange={onChange}
                className="text-base font-jost font-normal text-black"
              >
                Remember Me
              </Checkbox>
            </div>
          ...
          <button className=" bg-black text-white p-5 w-full text-base font-jost font-normal rounded-md">
            Login
          </button>
          <div className="flex gap-3 text-base font-jost font-normal justify-center mt-5">
            ...
            <Link
              href={"/signup"}
              className="text-[#D96936] hover:text-[#2653A8]"
            >
              Sign Up
            </Link>
          </div>
